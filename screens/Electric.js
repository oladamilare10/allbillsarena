...
const electricPlan =[
    {code: "abuja-electric", name:"Abuja Electricity Distribution Company (AEDC)", fee: 100},
    {code: "eko-electric", name:"Eko Electricity Distribution Company (EKEDC)", fee: 100},
    {code: "ibadan-electric", name:"Ibadan Electricity Distribution Company (IBEDC)", fee: 100},
    {code: "ikeja-electric", name:"Ikeja Electricity Distribution Company (IKEDC)", fee: 100},
    {code: "jos-electric", name:"Jos Electricity Distribution PLC (JEDplc)", fee: 100},
    {code: "kaduna-electric", name:"Kaduna Electricity Distribution Company (KAEDCO)", fee: 100},
    {code: "kano-electric", name:"Kano Electricity Distribution Company (KEDCO)", fee: 100},
    {code: "portharcourt-electric", name:"Port Harcourt Electricity Distribution Company (PHED)", fee: 100},
]

const Electric = ({ navigation }) => {
    ...
    const [selected, setSelected] = React.useState({
      ...
      const [defaultText, setDefaultText] = React.useState(dSelected.name)
      const fee = 0
    ...
    const newAmount = addAmount(Number(amount), Number(dSelected.fee));
    ...
    const urlVerify = "https://vtu.ng/wp-json/api/v1/verify-customer?username=Allbillsarena&password=Allbillsarena2023&customer_id="+ userId +"&service_id="+ dSelected.code +"&variation_id=" + prepaid
...
const checkPhoneNumber = ()=> {
    if (phone === '' || !phone) {
        setPhoneNumberErr('Phone field cannot be empty')
        setMsg(null)
    }else{
              ...
              if (userId && dSelected && selected){
                if(Number(amount) > Number(balance.w_balance)){
                  ...
                  setModalVisibleErr(true)
                    ...
                    const urlPay = "https://vtu.ng/wp-json/api/v1/electricity?username=Allbillsarena&password=Allbillsarena2023&phone=" + phone + "&meter_number=" + userId + "&service_id=" + dSelected.code + "&variation_id=" +prepaid +"&amount="+ newAmount
    ...
    function renderHeader() {
        return (
            ...
            >
                ...
                <Text style={{ marginLeft: SIZES.padding * 1.5, color: COLORS.emerald, ...FONTS.h4 }}>Electric</Text>
            </TouchableOpacity>
        )
    }
    ...
    function renderForm() {
        return (
            ...
            >   
                ...
                <Text style={{marginTop: 10, ...styles.ttText}}>Select Electric Company</Text>
                <TouchableOpacity style={{alignItems:'center',marginTop:15, ...styles.caseTab}} onPress={handleShow}>
                    ...
                    {amount && <View style={styles.amountBox}>
                        ...
                        <Text>Fee: {Naira.format(dSelected.fee)}</Text>
                    </View>}
                ...
                <View style={{ marginTop: SIZES.padding * 3 }}>
                    <Text style={{ color: COLORS.gray, ...FONTS.body3 }}>Meter ID</Text>
                    <TextInput
                        style={{
                ...
                <View style={{ marginTop: SIZES.padding * 3 }}>
                    ...
                    <TextInput
                        ...
                        selectionColor={COLORS.emerald}
                    />
                    {phoneNumberErr && <Text style={styles.errText}>{phoneNumberErr}</Text>}
                </View>
            </View>
        )
    }
        ...
        >
            ...
            >
                <ScrollView>
                    ...
                    {modalCodeVisible && <ModalCode ngn={newAmount} service={dSelected.name} submitForm={submitForm} modalCodeVisible={modalCodeVisible} setModalCodeVisible={setModalCodeVisible} resMessage={payErr} />}
