...
const EditProfile = ({ navigation }) => {
  ...
  const url = 'https://api.allbillsarena.com.ng/update_user.php'
    const header = {
    ...
    function renderHeader() {
        return (
            ...
            >
                ...
                <Text style={{ marginLeft: SIZES.padding * 1.5, color: COLORS.emerald, ...FONTS.h4 }}>Edit Profile</Text>
            </TouchableOpacity>
        )
    }
        ...
        return (
            ...
            >   
                <View style={{ marginTop: SIZES.padding * 3 }}>
                    <Text style={{ color: COLORS.gray, ...FONTS.body3 }}>Change First Name</Text>
                    <TextInput
                        style={{
                ...
                <View style={{ marginTop: SIZES.padding * 3 }}>
                    <Text style={{ color: COLORS.gray, ...FONTS.body3 }}>Change Last Name</Text>
                    <TextInput
                        style={{
                            marginVertical: SIZES.padding,
                            borderBottomColor: COLORS.emerald,
        ...
        >
            ...
            >
                <ScrollView>
                    ...
                    {modalCodeVisible && <ModalCode service="profile update" submitForm={handlePasswordUpdate} modalCodeVisible={modalCodeVisible} setModalCodeVisible={setModalCodeVisible} resMessage={payErr} />}
